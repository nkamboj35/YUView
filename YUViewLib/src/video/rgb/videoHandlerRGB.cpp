...
std::vector<rgb::PixelFormatRGB> videoHandlerRGB::formatPresetList = {
    ...
    // BF16 3-channel packed
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::RGB, AlphaMode::None,
                   Endianness::Little, SampleType::BFloat16),
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::BGR, AlphaMode::None,
                   Endianness::Little, SampleType::BFloat16),
    // BF16 3-channel planar
    PixelFormatRGB(16, DataLayout::Planar, ChannelOrder::RGB, AlphaMode::None,
                   Endianness::Little, SampleType::BFloat16),
    PixelFormatRGB(16, DataLayout::Planar, ChannelOrder::BGR, AlphaMode::None,
                   Endianness::Little, SampleType::BFloat16),
    // BF16 4-channel packed (RGBA / RGBx / BGRA / BGRx)
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::RGB, AlphaMode::Last,
                   Endianness::Little, SampleType::BFloat16),
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::RGB, AlphaMode::Last,
                   Endianness::Little, SampleType::BFloat16, true),
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::BGR, AlphaMode::Last,
                   Endianness::Little, SampleType::BFloat16),
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::BGR, AlphaMode::Last,
                   Endianness::Little, SampleType::BFloat16, true),
    // FP16 3-channel packed
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::RGB, AlphaMode::None,
                   Endianness::Little, SampleType::Float16),
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::BGR, AlphaMode::None,
                   Endianness::Little, SampleType::Float16),
    // FP16 3-channel planar
    PixelFormatRGB(16, DataLayout::Planar, ChannelOrder::RGB, AlphaMode::None,
                   Endianness::Little, SampleType::Float16),
    PixelFormatRGB(16, DataLayout::Planar, ChannelOrder::BGR, AlphaMode::None,
                   Endianness::Little, SampleType::Float16),
    // FP16 4-channel packed (RGBA / RGBx / BGRA / BGRx)
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::RGB, AlphaMode::Last,
                   Endianness::Little, SampleType::Float16),
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::RGB, AlphaMode::Last,
                   Endianness::Little, SampleType::Float16, true),
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::BGR, AlphaMode::Last,
                   Endianness::Little, SampleType::Float16),
    PixelFormatRGB(16, DataLayout::Packed, ChannelOrder::BGR, AlphaMode::Last,
                   Endianness::Little, SampleType::Float16, true),
    // FP32 3-channel packed
    PixelFormatRGB(32, DataLayout::Packed, ChannelOrder::RGB, AlphaMode::None,
                   Endianness::Little, SampleType::Float32),
    PixelFormatRGB(32, DataLayout::Packed, ChannelOrder::BGR, AlphaMode::None,
                   Endianness::Little, SampleType::Float32),
    // FP32 3-channel planar
    PixelFormatRGB(32, DataLayout::Planar, ChannelOrder::RGB, AlphaMode::None,
                   Endianness::Little, SampleType::Float32),
    PixelFormatRGB(32, DataLayout::Planar, ChannelOrder::BGR, AlphaMode::None,
                   Endianness::Little, SampleType::Float32),
    // FP32 4-channel packed (RGBx / BGRx)
    PixelFormatRGB(32, DataLayout::Packed, ChannelOrder::RGB, AlphaMode::Last,
                   Endianness::Little, SampleType::Float32, true),
    PixelFormatRGB(32, DataLayout::Packed, ChannelOrder::BGR, AlphaMode::Last,
                   Endianness::Little, SampleType::Float32, true)};
